...
import OnboardingDialog from '@/components/seller/OnboardingDialog'
import DashboardRedirectButton from '@/components/seller/DashboardRedirectButton'
...
function SellerPage() {
  ...
  return (
    <>
      ...
      <SellerContent isAuthenticated={isAuthenticated} />
