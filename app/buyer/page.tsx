...
import OnboardingDialog from '@/components/buyer/OnboardingDialog'
import DashboardRedirectButton from '@/components/buyer/DashboardRedirectButton'
...
function BuyerPage() {
  ...
  return (
    <>
      ...
      <BuyerContent isAuthenticated={isAuthenticated} />
